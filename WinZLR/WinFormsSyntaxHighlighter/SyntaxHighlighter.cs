...
namespace winZLR.WinFormsSyntaxHighlighter
{
    public class SyntaxHighlighter
    {
        ...
        public SyntaxHighlighter(RichTextBox richTextBox)
        {
            ...
            // TODO: Disabled and done manually instead
        ...
        {
            // TODO: Disabled, because sometimes it didn't fire
            //ReHighlight();
        }
        ...
        private List<Expression> ProcessLineBreaks(List<Expression> expressions)
        {
            ...
            foreach (var inputExpression in expressions)
            {
                ...
                {
                    string nonMatchedContent = inputExpression.Content[(lastProcessedIndex + 1)..];
        ...
        private static List<Expression> ParsePattern(PatternStyleMap patternStyleMap, List<Expression> expressions)
        {
            var parsedExpressions = new List<Expression>();
